<%-- 
    Document   : claim_ensura
    Created on : 25-May-2023, 6:14:39 pm
    Author     : HP
--%>
            ...
            <div class="col-md-5 col-xl-5 pe-xxl-0">
              <div class="card card-bg shadow hero-header-form">
                <div class="card-body p-4 p-xl-6">
                  <h2 class="text-100 text-center">Claim Your Insurance</h2>
                  <form class="mb-3" action="claiming" method="post" commandName="user">
                    <div class="form-floating mb-3"><input class="form-control input-box form-ensurance-header-control" id="floatingName" type="text" placeholder="name" name="accident_location"><label for="floatingName" >Location of accident</label></div>
                    <div class="form-floating mb-3"><input class="form-control input-box form-ensurance-header-control" id="floatingEmail" type="text" placeholder="name@example.com" name="date_of_accident"><label for="floatingEmail">Date of accident</label></div>
                    <div class="form-floating mb-3"><input class="form-control input-box form-ensurance-header-control" id="floatingCatrgory" type="text" placeholder="Insurance Category" name="damage_amount"><label for="floatingCatrgory">Damage amount</label></div>
                    <div class="form-floating mb-3"><textarea class="form-control input-box form-ensurance-header-control" id="floatingTextarea" placeholder="Leave a comment here" name="accident_description"></textarea><label for="floatingTextarea">Describe your accident</label></div>
                    <div class="col-12 d-grid"> <button class="btn btn-primary rounded-pill" type="submit">Claim</button></div>
                  </form>
                </div>
              </div>
            </div>
...
<!--    <script>
            alert("You have claimed the insurance amount.\n\
        The amount will be transferred to your account within 5-6 working days\n\
        The amount transferred is based on the rules of the insurance you can see the commpany's qoute to see the rules.");
    </script>-->
